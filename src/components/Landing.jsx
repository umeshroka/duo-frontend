  ...
  return (
    <div>
      ...
      <section>
        ...
        <p>
          Explore traditional Chinese art through our collection of
          masterpieces, learn from experts, and experience the beauty of this
          ancient tradition.
        </p>
      ...
      {featuredArtist && (
        <section>
          ...
          <div>
            {/* Featured Artwork */}
            <div>
              {featuredArtist.artworks?.[0]?.imageUrl && (
                <Link to={`/artworks/${featuredArtist.artworks[0].id}`}>
                  ...
                  <div>
                    ...
                    <p>
                      {featuredArtist.name},{" "}
                      {featuredArtist.artworks[0].year || "n.d."}
                    </p>
                  </div>
                </Link>
              )}
            ...
            <div>
              ...
              <p>
                ...
                {featuredArtist.deathYear || "Present"}
              </p>
            ...
            {recentEditorials.map((editorial) => (
              <div key={editorial.id}>
                <Link to={`/editorials/${editorial.id}`}>
                  <div>
                    {editorial.imageUrl && (
                      <img src={editorial.imageUrl} alt={editorial.title} />
                    )}
                  </div>
